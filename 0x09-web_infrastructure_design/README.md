...
chmod u+x 2-secured_and_monitored_web_infrastructure.md && git add --chmod=+x 2-secured_and_monitored_web_infrastructure.md && git commit -m 'Task 02  Secured and monitored web infrastructure 2-secured_and_monitored_web_infrastructure.md'
 && git push

touch 2-secured_and_monitored_web_infrastructure.md && git add . && git commit -m 2-secured_and_monitored_web_infrastructure.md
