...
chmod u+x 1-create_ssh_key_pair && git add --chmod=+x 1-create_ssh_key_pair && git commit -m 'Task 01 a Bash script that creates an RSA key pair. 1-create_ssh_key_pair' && git push
