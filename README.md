...
chmod u+x 3-app_server-nginx_config && git add --chmod=+x 3-app_server-nginx_config && git commit -m 'Task 03 3-app_server-nginx_config' && git push

touch 3-app_server-nginx_config && git add . && git commit -m 3-app_server-nginx_config
