...
chmod u+x 1-export_to_CSV.py && git add --chmod=+x 1-export_to_CSV.py && git commit -m 'Task 01 1-export_to_CSV.py' && git push

touch 1-export_to_CSV.py && git add . && git commit -m 1-export_to_CSV.py
