...
chmod u+x 5-mysql_backup && git add --chmod=+x 5-mysql_backup && git commit -m 'Task 00 5-mysql_backup' && git push

touch 5-mysql_backup && git add . && git commit -m 5-mysql_backup
